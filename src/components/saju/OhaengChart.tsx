...
// ── 음양 매핑 ──────────────────────────────────────────────
const CHEONGAN_YANG = new Set(["甲", "丙", "戊", "庚", "壬", "갑", "병", "무", "경", "임"]);
const CHEONGAN_YIN  = new Set(["乙", "丁", "己", "辛", "癸", "을", "정", "기", "신", "계"]);
const JIJI_YANG     = new Set(["子", "寅", "辰", "午", "申", "戌", "자", "인", "진", "오", "신", "술"]);
const JIJI_YIN      = new Set(["丑", "卯", "巳", "未", "酉", "亥", "축", "묘", "사", "미", "유", "해"]);
